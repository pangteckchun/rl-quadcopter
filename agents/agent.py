...
class Quadcopter_Agent():
    ...
    def step (self, alpha, gamma, eps, action, reward, state, next_state):
        self.Q[tuple(state)] = self.task.update_Q_expsarsa(alpha, gamma, self.task.action_size, eps, self.Q, \
